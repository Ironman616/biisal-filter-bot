...
USERNAME = environ.get('USERNAME', "https://telegram.me/TonYStarkk616")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-10019494867581'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+y-CY8PtZLS82ZDE1')
...
URL = environ.get('URL', 'linear-suzette-aibottz-5a83a683.koyeb')
STICKERS_IDS = ('CAACAgQAAxkBAAEK9T1mq9shoDlh3xQxvUhAVovWFjl4MQAC1AIAAnJxFyVUIYkDHFAofB4E').split()
